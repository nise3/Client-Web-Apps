  ...
  return (
    <>
      <Grid>
        ...
        <Grid>
          <Grid mt={8}>
            <Grid md={8} container className={classes.filterMainGrid}>
              <Grid item md={1}>
                <Grid container>
                  <Grid item md={2}>
                    <FilterListIcon />
              ...
              <Grid item md={3}>
                <Paper
                  component='form'
                  sx={{p: '2px 4px', display: 'flex', alignItems: 'center', height: 40}}
                >
                  <InputBase
                    sx={{ml: 1, flex: 1}}
          ...
          <Grid mt={8}>
            <Grid container md={8} className={classes.cardMainGrid}>
              <Grid item xs={12}>
                <Typography gutterBottom variant='h6' component='div' display={'flex'}>
                  মোট ফলাফল পাওয়া গেছে
                  <Typography variant='h6' component='div' className={classes.typographyNumber}>
                    ১৫
                  </Typography>
                </Typography>
              </Grid>
              <Grid item xs={12}>
                <Grid container spacing={5}>
                  {courseList.map((course: any) => {
                    return (
                      <Grid item md={3} justifyContent={'center'} mt={3} key={course.id}>
