...
const JobCircularDetails = () => {
  ...
  const jobCircularDetails = {
    ...
    vacancy: '৫',
    job_responsibility:
      'যানবাহন বেবস্থাপনায় সহায়তা করা, এডমিন সংক্রান্ত সব তথ্য প্রস্তুত করা ',
    job_type: 'ফুল টাইম',
    educational_requirement: 'BSc',
    job_requirements:
      'বয়স ২২ থেকে ২৫ বছর, সক্রিয় ও পরিশ্রমী, উভয় ছেলে মেয়ে আবেদন করতে পারবে, সক্রিয় ও পরিশ্রমী',
          ...
          <Grid container>
            ...
            <Grid item xs={12} md={8}>
              <div className={classes.divDesign}>
                ...
                <Typography gutterBottom={true} className={classes.value}>
              ...
              <Typography gutterBottom={true} className={classes.value}>
                ...
                {jobCircularDetails.salary} {messages['common.taka']}
              </Typography>
            </Grid>
                  ...
                  <Box p={2}>
                    <Typography gutterBottom={true}>
                      <span style={{fontWeight: 'bold'}}>
                        {messages['industry.release_date']}
                      </span>
                      <ArrowRightAlt sx={{marginBottom: '-6px'}} />{' '}
                      {jobCircularDetails.release_date}
                    </Typography>
                    ...
                    <Typography gutterBottom={true}>
                      <span style={{fontWeight: 'bold'}}>
                        {messages['industry.required_age']}
                      </span>
                      <ArrowRightAlt sx={{marginBottom: '-6px'}} />
                      {jobCircularDetails.required_age}
                    </Typography>

                    <Typography gutterBottom={true}>
                      <span style={{fontWeight: 'bold'}}>
                        {messages['industry.gender']}
                      </span>
                      <ArrowRightAlt sx={{marginBottom: '-6px'}} />
                      {jobCircularDetails.gender}
                    </Typography>
                    ...
                    <Typography gutterBottom={true}>
                      <span style={{fontWeight: 'bold'}}>
                        {messages['industry.application_deadline']}{' '}
                      </span>
                      <ArrowRightAlt sx={{marginBottom: '-6px'}} />
                      {jobCircularDetails.application_deadline}
                    </Typography>
                  </Box>
                </Card>
              </Box>
