...
import {FILE_LOG_PROJECT_CURRICULUM_STEP} from '../4IRSteppers/fourIRFileLogConstant';
  ...
  const {onFetchData, data, loading, pageCount, totalCount} =
    useReactTableFetchData({
      ...
      paramsValueModifier: (params) => {
        ...
        params['file_log_step'] = FILE_LOG_PROJECT_CURRICULUM_STEP;
        return params;
      },
    });

  console.log('File Logs in CS :', data);
        ...
        <Grid container spacing={5}>
          ...
          <Grid item xs={12}>
            <Typography
              ...
              {messages['4ir.curriculum_previous_files']}
            </Typography>
            <ReactTable
              columns={columns}
              data={data}
