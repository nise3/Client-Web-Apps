...
import {deleteRPLQuestion} from '../../../services/CertificateAuthorityManagement/RPLQuestionBankService';

const RPLQuestionBankPage = () => {
  ...
  const deleteRTOQuestionItem = async (itemId: number) => {
    let response = await deleteRPLQuestion(itemId);
...
export default RPLQuestionBankPage;
