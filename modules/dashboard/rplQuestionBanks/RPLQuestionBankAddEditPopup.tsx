...
import {
  createRPLQuestion,
  updateRPLQuestion,
} from '../../../services/CertificateAuthorityManagement/RPLQuestionBankService';
...
const RPLQuestionBankAddEditPopup: FC<RTOQuestionAddEditPopupProps> = ({
  itemId,
  refreshDataTable,
  ...props
}) => {
  ...
  const onSubmit: SubmitHandler<any> = async (data: any) => {
    ...
    try {
      if (itemId) {
        await updateRPLQuestion(itemId, data);
        updateSuccessMessage('question.label');
        mutateRTOQuestion();
      } else {
        await createRPLQuestion(data);
...
export default RPLQuestionBankAddEditPopup;
