...
const SkillsDevelopmentTrainingActivitiesIncomeExpenditureInformationDetailsPopup =
  ({itemId, ...props}: IProps) => {
              ...
              <fieldset>
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={12} md={6}>
                    <DetailsInputView
                      value={
                        itemData?.course_income_from_application_and_others
                      }
                      isLoading={isLoading}
                      label={
                        messages[
...
export default SkillsDevelopmentTrainingActivitiesIncomeExpenditureInformationDetailsPopup;
