...
} from '../../../services/CertificateAuthorityManagement/RPLAssessmentQuestionSetService';
...
const RPLAssessmentQuestionSetAddEditPopup: FC<SubjectAddEditPopupProps> = ({
  itemId,
  refreshDataTable,
  ...props
}) => {
...
export default RPLAssessmentQuestionSetAddEditPopup;
