...
import {addRPLQuestionsToAssessment} from '../../../services/CertificateAuthorityManagement/RPLAssessmentService';
...
const AddQuestionIntoSetPopup: FC<AddQuestionPopupProps> = ({
  itemId,
  assessmentId,
  refreshDataTable,
  ...props
...
export default AddQuestionIntoSetPopup;
