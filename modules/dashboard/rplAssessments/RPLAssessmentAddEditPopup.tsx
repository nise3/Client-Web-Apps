...
import {
  createRPLAssessment,
  updateRPLAssessment,
} from '../../../services/CertificateAuthorityManagement/RPLAssessmentService';
...
const RPLAssessmentAddEditPopup: FC<AssessmentAddEditPopupProps> = ({
  itemId,
  refreshDataTable,
  ...props
}) => {
...
export default RPLAssessmentAddEditPopup;
