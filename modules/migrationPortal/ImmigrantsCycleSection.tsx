...
import {
    LINK_FRONTEND_MIGRATION_PORTAL_REGISTRATION, LINK_FRONTEND_MIGRATION_PORTAL_TRAINING_LINKS,
        ...
        <StyledContainer maxWidth='lg'>
            <Box className={classes.image}>
                ...
                <Grid container className={classes.secondRow}>
                    ...
                    <Grid item xs={6}>
                        <Link href={LINK_FRONTEND_MIGRATION_PORTAL_TRAINING_LINKS}>{messages['menu.training']}</Link>
                    </Grid>
                </Grid>
                {isMDDown ? (
                    ...
                    <Grid container className={classes.thirdRow}>
                        ...
                        <Grid item xs={4}>
                            <Link
                                href={LINK_FRONTEND_MIGRATION_PORTAL_REGISTRATION}>
                ...
                {isMDDown ? (
                    <Grid container className={classes.secondButton}>
                        ...
                        <Grid item xs={6}>
                            <Link
                                href={LINK_FRONTEND_MIGRATION_PORTAL_TRAINING_LINKS}
