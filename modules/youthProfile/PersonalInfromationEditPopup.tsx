...
interface PersonalInformationEditPopupProps {
  itemId: number | null;
  onClose: () => void;
}

const PersonalInformationEditPopup: FC<PersonalInformationEditPopupProps> = ({itemId, ...props}) => {
  ...
  const validationSchema = useMemo(() => {
    return yup.object().shape({
      ...
      middle_name: yup
        .string()
        .label(messages['common.middle_name'] as string),
    ...
    <HookFormMuiModal
      ...
      title={
        <>
            <IntlMessages
              id='common.edit'
              values={{subject: <IntlMessages id='personal_info_edit.label' />}}
            />
        </>
      }
      maxWidth={'sm'}
        ...
        <Grid style={{marginTop: '20px'}} item xs={8}>
          ...
          <label htmlFor='contained-button-file'>
            <Button
              ...
              color='primary'
              component='span'>
              <CloudUploadOutlinedIcon style={{marginRight: '5px', fontSize: 30}} /> Upload new picture
            </Button>
          </label>
        </Grid>
        <Grid item xs={6}>
        ...
        <Grid item xs={8}>
          <label htmlFor='contained-button-file'>
            <Button
              ...
              color='primary'
              component='span'>
              <CloudUploadOutlinedIcon style={{marginRight: '20px', fontSize: 30}} /> Upload CV
            </Button>
          </label>
          <input
            type='file'
...
export default PersonalInformationEditPopup;
