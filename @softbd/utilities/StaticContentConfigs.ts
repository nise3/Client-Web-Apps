export const SELF_ASSESSMENT_CONTENT_ID = 'self_assessment';
export const HOW_NISE3_WORKS_CONTENT_ID = 'how_nise3_works';
export const ABOUT_US_CONTENT_ID = 'about_us';
