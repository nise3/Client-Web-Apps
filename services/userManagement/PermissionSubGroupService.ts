...
export const getPermissionSubGroup = async (permissionSubGroupId: number) => {
    try {
        let response: any = await apiGet(API_PERMISSION_SUB_GROUPS + "/" + permissionSubGroupId);
        return response.data.data;
    } catch (error) {
        catchBlockHandler(error);
    }
...
export const updatePermissionSubGroup = async (permissionSubGroupId: number, data: PermissionSubGroup) => {
    try {
        let response: any = await apiPut(API_PERMISSION_SUB_GROUPS + "/" + permissionSubGroupId, data);
        return response.data._response_status.success;
    } catch (error) {
        catchBlockHandler(error);
    }
...
export const deletePermissionSubGroup = async (permissionSubGroupId: number) => {
    try {
        let response: any = await apiDelete(API_PERMISSION_SUB_GROUPS + "/" + permissionSubGroupId);
        return response.data._response_status.success;
    } catch (error) {
        catchBlockHandler(error);
    }
