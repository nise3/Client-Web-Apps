...
export const API_HUMAN_RESOURCES = ORGANIZATION_SERVICE_PATH + '/human-resources;'

export const getAllHumanResources = async () => {
    try {
        let response: any = await apiGet(API_HUMAN_RESOURCES);
...
export const getHumanResource = async (humanResourceId: number) => {
    try {
        let response: any = await apiGet(API_HUMAN_RESOURCES + "/" + humanResourceId);
        return response.data.data;
    } catch (catchBlockHandler) {
    }
};
...
export const deleteHumanResource = async (humanResourceId: number) => {
    try {
        let response: any = await apiDelete(API_HUMAN_RESOURCES + "/" + humanResourceId);
...
export const updateHumanResource = async (humanResourceId: number, data: HumanResource) => {
    try {
        let response: any = await apiPut(API_HUMAN_RESOURCES + "/" + humanResourceId, data);
        return response.data._response_status.success;
    } catch (catchBlockHandler) {
    }
};
